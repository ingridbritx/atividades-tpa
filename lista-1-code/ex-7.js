...
console.log ('O quarto resultado é:', resultado4);
console.log ('O quinto resultado é: ', resultado5);
console.log ('O sexto resultado é: ', resultado6);
console.log ('O setimo resultado é: ', resultado7);
